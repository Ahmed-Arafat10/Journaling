            ...
            <form action="" method="POST">
                <div class="col">
                    <div class="col">
                        ...
                        <input id="AddData" class="form-control " type="text" name="task_input" id="NoteIN" placeholder="Enter Task Here">
                    </div>
                </div>
                <div class="col">
                    <div class="text-center">
                        <button style="margin-top: 20px;" type="submit" name="addNewTaskBtn" class="btn btn-outline-primary text-center">Add task</button>
                    </div>
                </div>
            </form>
        </div>
